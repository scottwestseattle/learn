...
<div class="container">
	...
	<div style="margin-top: 5px;">
		...
		<div style="margin: 0 5px 0 0;">
			...
			@if (true)
				<span style="font-size:1.3em; margin-right:10px;" class=""><a onclick="event.preventDefault(); zoom(-3);" href=""><span id="button-zoom-out" class="glyphicon glyphicon-zoom-out"></span></a></span>
				<span style="font-size:1.3em; margin-right:10px;" class=""><a onclick="event.preventDefault(); zoom(3);" href=""><span id="button-zoom-in" class="glyphicon glyphicon-zoom-in"></span></a></span>				
			@else
			<!-- old way -->
			...
			@endif
			<span id="clock" class="small-thin-text" style=""></span>
		</div>
