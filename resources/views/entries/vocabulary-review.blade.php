...
<div class="container">
	...
	<div style="margin-top: 5px;">
		...
		<div style="float:left; margin: 0 5px 0 0;">
			<span style="font-size:1.3em;" class=""><a class="" role="" href="{{$referrerUrl}}"><span class="glyphicon glyphicon-button-back-to"></span></a></span>
		</div>
		...
		<!-------------------------------------------------------->
		<div id="stats">
			<div class="middle mt-1 mr-1"><a href="{{$referrerUrl}}"><span class="glyphicon glyphReaderReturn glyphicon-circle-arrow-up"></span></a></div>
...
<section xstyle="max-width: 600px;" class="quizSection" id='sectionQna'>
	...
	<div id="panel-start" class="quiz-panel text-center">
		...
		<div class="btn-panel-bottom pb-2">
			...
			<a class="" role="" href="{{$referrerUrl}}"><button class="btn btn-lg btn-primary btn-quiz" >@LANG('ui.Quit')</button></a>
		</div>
